...
#ifndef LLVM_LIB_BITCODE_LEGACYWRITER_VALUEENUMERATOR180_H
#define LLVM_LIB_BITCODE_LEGACYWRITER_VALUEENUMERATOR180_H
...
public:
  ValueEnumerator180(const Module &M, bool ShouldPreserveUseListOrder);
  ValueEnumerator180(const ValueEnumerator180 &) = delete;
  ValueEnumerator180 &operator=(const ValueEnumerator180 &) = delete;
  ...
  unsigned getTypeID(Type *T) const {
    ...
    assert(I != TypeMap.end() && "Type not in ValueEnumerator180!");
    return I->second-1;
  }
  ...
  unsigned getAttributeListID(AttributeList PAL) const {
    ...
    assert(I != AttributeListMap.end() && "Attribute not in ValueEnumerator180!");
    return I->second;
  }
  ...
  unsigned getAttributeGroupID(IndexAndAttrSet Group) const {
    ...
    // has no LLVM 18 encoding) misses here; tell the caller to drop it.
  ...
  /// use these two methods to get its data into the ValueEnumerator180!
...
#endif // LLVM_LIB_BITCODE_LEGACYWRITER_VALUEENUMERATOR180_H
