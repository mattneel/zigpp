//===- Bitcode/Writer/ValueEnumerator140.h - Number values ---------*- C++ -*-===//
//
...
#ifndef LLVM_LIB_BITCODE_LEGACYWRITER_VALUEENUMERATOR140_H
#define LLVM_LIB_BITCODE_LEGACYWRITER_VALUEENUMERATOR140_H
...
public:
  ValueEnumerator140(const Module &M, bool ShouldPreserveUseListOrder);
  ...
  unsigned getTypeID(Type *T) const {
    ...
    assert(I != TypeMap.end() && "Type not in ValueEnumerator140!");
    return I->second-1;
  }
  ...
  unsigned getAttributeListID(AttributeList PAL) const {
    ...
    assert(I != AttributeListMap.end() && "Attribute not in ValueEnumerator140!");
    return I->second;
  }
  ...
  /// use these two methods to get its data into the ValueEnumerator140!
...
#endif // LLVM_LIB_BITCODE_LEGACYWRITER_VALUEENUMERATOR140_H
